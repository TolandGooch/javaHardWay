...
public class AgeMessages {
	public static void main( String[] args) {
		...
		if ( age < 16 ) {
			System.out.println( "\ttoo young to get driver's licence" );
		}
		if ( age >= 16 ) {
			System.out.println( "\told enough to get driver's licence" );
		}
		if ( age < 18 ) {
		...
		// anything over 35 will not print because it haves not been defined.
		if ( age >= 65) {
